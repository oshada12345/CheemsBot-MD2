...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, jawab, '© ⛧ S A T H A N ⸸ ', m, {mentions: ments})
            }
            break
            case 'jadian': {
            if (!m.isGroup) throw mess.group
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, jawab, '© ⛧ S A T H A N ⸸ ', m, {mentions: menst})
            }
            break
            case 'react': {
                if (!isCreator) throw mess.owner
...
break
        case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            break
               case 'group': case 'grup': {
                ...
                let buttons = [
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, `Mode Group`, '© ⛧ S A T H A N ⸸ ', m)
            ...
            case 'editinfo': {
             ...
             let buttons = [
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, `Mode Edit Info`, '© ⛧ S A T H A N ⸸ ', m)
            ...
            case 'antilink': {
                ...
                m.reply(`Antilink Tidak Aktif !`)
                 ...
                 let buttons = [
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, `Mode Antilink`, '© ⛧ S A T H A N ⸸ ', m)
                }
             }
             break
             case 'mute': {
                ...
                m.reply(`${'© ⛧ S A T H A N ⸸ '} telah di unmute di group ini !`)
                 ...
                 let buttons = [
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, `Mute Bot`, '© ⛧ S A T H A N ⸸ ', m)
                }
             }
             break
            ...
            case 'ephemeral': {
                ...
                hisoka.sendListMsg(m.chat, `Please select the following Ephemeral Options List !`, '© ⛧ S A T H A N ⸸ ', `Hello Admin ${groupMetadata.subject}`, `Click Here`, sections, m)
                }
            }
            break
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                      ...
                      hisoka.send5ButImg(i, txt, '© ⛧ S A T H A N ⸸ ', global.thumb, btn)
                    }
        ...
        let { webp2mp4File } = require('./lib/uploader')
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            hisoka.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${'© ⛧ S A T H A N ⸸ '}.mp3`}, { quoted : m })
            }
            break
        ...
        case 'anonymous': {
            ...
            case 'mulai': case 'start': {
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, `\`\`\`Kamu Masih Berada Di dalam Sesi Anonymous, Tekan Button Dibawah Ini Untuk Menghentikan Sesi Anonymous Anda\`\`\``, '© ⛧ S A T H A N ⸸ ', m)
                    throw false
                }
                ...
                if (room) {
                    ...
                    await hisoka.sendButtonText(room.a, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, '© ⛧ S A T H A N ⸸ ', m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await hisoka.sendButtonText(room.b, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, '© ⛧ S A T H A N ⸸ ', m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, `\`\`\`Mohon Tunggu Sedang Mencari Partner\`\`\``, '© ⛧ S A T H A N ⸸ ', m)
                }
                break
            }
...
⭔ Detail: ${detail}`
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                hisoka.sendListMsg(m.chat, `Please select the menu you want to change!`, '© ⛧ S A T H A N ⸸ ', `Hello owner !`, `Click Here`, sections, m)
                }
            }
            break
...
let btn = [{
            ...
            break
case 'dana': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/03c5633ef82ee488a6afc.jpg' }, caption: `Gopay` }, { quoted: m })
            }
            break
case 'dana': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/03c5633ef82ee488a6afc.jpg' }, caption: `DANA` }, { quoted: m })
            }
            break
case 'pulsa': {
